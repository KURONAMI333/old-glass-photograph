 ...
 * 上＝カメラ本体を置く。vanilla の {@code DoubleHighBlockItem} と同じ型で、
 * 置く前に上のマスを明示的に空ける（水源ブロックなら水のまま残す）。
 */
public class WetPlateCameraBlockItem extends BlockItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip,
        ...
        tooltip.add(line("tooltip.old_glass_photograph.camera.facing"));
        tooltip.add(line("tooltip.old_glass_photograph.camera.stand_behind"));
    }
