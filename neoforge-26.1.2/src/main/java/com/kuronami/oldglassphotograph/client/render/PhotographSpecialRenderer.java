...
public final class PhotographSpecialRenderer implements SpecialModelRenderer<PhotographSpecialRenderer.Plate> {
    ...
    @Override
    public void submit(@Nullable Plate plate, PoseStack poseStack, SubmitNodeCollector collector,
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked<Plate> {
        ...
        @Override
        public SpecialModelRenderer<Plate> bake(SpecialModelRenderer.BakingContext context) {
